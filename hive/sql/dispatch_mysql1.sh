sql="select dt, stype, origin_url as suburl, count(*), sum(tosize), count(distinct actor) from stat_dispatch where dt='$1' and mcdispatcher='' group by dt, stype, origin_url;"
